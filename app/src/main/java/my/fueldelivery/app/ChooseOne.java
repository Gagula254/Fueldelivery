...
public class ChooseOne extends AppCompatActivity {
    Button Attendant,Customer,DeliveryPerson;
    Intent intent;
    String type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Attendant = (Button)findViewById(R.id.attendant);
        ...
        Attendant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(type.equals("Email")){
                    Intent loginemail  = new Intent(ChooseOne.this,Attendantlogin.class);
...
//                }
                if(type.equals("SignUp")){
                    Intent Register  = new Intent(ChooseOne.this,AttendantRegistration.class);
