...
import my.fueldelivery.app.ReusableCodeForAll;

import java.util.ArrayList;
import java.util.HashMap;

public class AttendantRegistration extends AppCompatActivity {

    String[] Kenya = {"Nairobi","Kisumu","Mombasa"};
//    String[] Madhyapradesh = {"Bhopal","Indore","Ujjain"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendant_registration);
...
//        Phone = (Button)findViewById(R.id.phone);
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Kenya")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : Kenya){
                        list.add(cities);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AttendantRegistration.this,android.R.layout.simple_spinner_item,list);
...
//                }
        ...
        databaseReference = firebaseDatabase.getInstance().getReference("Attendant");
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(AttendantRegistration.this);
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance().getReference("Attendant")
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(AttendantRegistration.this);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(AttendantRegistration.this,"Error",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
...
//
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AttendantRegistration.this, Attendantlogin.class));
                finish();
            }
        });
